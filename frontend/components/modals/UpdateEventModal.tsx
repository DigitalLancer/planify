...
export default function UpdateEventModal() {
    ...
    if (modal.type !== "updateEvent") return null;
            ...
            <div className="relative w-full max-w-2xl bg-stone-50 p-8 shadow-2xl border-2 border-slate-900/10 rounded-2xl transition-all">
                ...
                <form className="space-y-3" onSubmit={handleSubmit}>
                    ...
                    <div className="pt-2">
                        <button
                            disabled={isPending}
                            className={`bg-indigo-500/90 text-white px-6 py-2 cursor-pointer font-handwriting md:text-xl shadow-md transition-all 
