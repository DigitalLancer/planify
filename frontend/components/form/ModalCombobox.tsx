  ...
  return (
    <div>
      ...
      <select
        ...
        className="w-full bg-white border-2 border-slate-900/30 rounded-xl px-4 py-2 outline-none focus:border-indigo-400 text-slate-700 font-handwriting transition-all"
        required
      >
